...
function setUpHelpers(server, mode, weatherApiKey, geocodeApiKey) {
...
const { weatherApiKey, geocodeApiKey, mode, port } = options[process.env.NODE_ENV]
const server = express()
setUpHelpers(server, mode, weatherApiKey, geocodeApiKey)
setUpLogging(server, mode)
setUpRouting(server, mode)
setUpServer(server, mode, port)
